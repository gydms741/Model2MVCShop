...
$(function(){
	...
	$( ".ct_list_pop td:nth-child(3)").on("click" , function() {
		...
		if("${param.menu}"=='manage'){
			...
			location.href ="/product/updateProduct?prodNo="+$(this).attr('id');
		}else {
			console.log('hello, it')
			location.href ="/product/getProduct?prodNo="+$(this).attr('id');
		}
		
	});
	$( ".ct_list_pop td:nth-child(1)" ).css("background-color" , "#C2DBF1");
	$( ".ct_list_pop td:nth-child(1)" ).css("color" , "gray");
	$( ".ct_list_pop td:nth-child(3)" ).css("color" , "blue");
	$( ".ct_list_pop td:nth-child(7)" ).css("color" , "darkblue");
	...
	$(".ct_list_pop:nth-child(4n+6)" ).css("background-color" , "#D5E8F8");
...
<c:set var="i" value="0" />
	<c:forEach var="product" items="${list }">
		...
		<tr class="ct_list_pop">
			...
			<a href="/product/updateProduct?prodNo=${product.prodNo}&${param.menu }">${product.prodName}</a>
			</c:when>
			 <c:otherwise>
